...
// we must manually form the array
// put together each food item with its price
void add_items(void)
{
    menu[0].item = "Burger";
    menu[0].price = 9.5;
...
// whatever food items the user inputs, add the price together
// return the sum of prices added together
float get_cost(string item)
{
    for (int i = 0; i < NUM_ITEMS; i++)
    {
        ...
        {
            return menu[i].price; //from array
        }
    }
    return 0.0;
}
